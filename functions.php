<?php
/**
 * Custom Starter Wordpress functions and definitions
 *
...
if ( ! function_exists( 'custom_template_setup' ) ) :
	...
	function custom_template_setup() {
		 ...
		 * If you're building a theme based on Custom Starter Wordpress, use a find and replace
...
function custom_template_scripts() {
	...
	wp_enqueue_script( 'custom-template-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
